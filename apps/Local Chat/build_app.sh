#!/bin/bash
# ==============================================================================
#                 Local Chat Compilation and Packaging Script
# ==============================================================================
set -e

# App configuration parameters
APP_NAME="Local Chat"
SRC_DIR="/Users/hassan/local-ai/apps/Local Chat"
...
echo -e "${BOLD}===========================================${NC}"
echo -e "${BOLD}      Compiling Local Chat App             ${NC}"
echo -e "${BOLD}===========================================${NC}\n"
...
swiftc -O \
    ...
    -sdk "$SDK_PATH" \
    "$SRC_DIR/main.swift" \
    -o "$BUILD_DIR/$APP_NAME.app/Contents/MacOS/LocalChat"
...
chmod +x "$BUILD_DIR/$APP_NAME.app/Contents/MacOS/LocalChat"
...
elif [ -f "/Users/hassan/local-ai/icns/Local Chat.icns" ]; then
    echo -e "Copying Local Chat icon as logo..."
    cp "/Users/hassan/local-ai/icns/Local Chat.icns" "$BUILD_DIR/$APP_NAME.app/Contents/Resources/AppIcon.icns"
fi
