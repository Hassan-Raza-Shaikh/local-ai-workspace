#!/bin/bash
# ==============================================================================
#                 AI Orchestrator Compilation and Packaging Script
# ==============================================================================
set -e

# App configuration parameters
APP_NAME="AI Orchestrator"
SRC_DIR="/Users/hassan/local-ai/apps/AI Orchestrator"
...
echo -e "${BOLD}===========================================${NC}"
echo -e "${BOLD}      Compiling AI Orchestrator App        ${NC}"
echo -e "${BOLD}===========================================${NC}\n"
...
swiftc -O \
    ...
    -sdk "$SDK_PATH" \
    "$SRC_DIR/main.swift" \
    -o "$BUILD_DIR/$APP_NAME.app/Contents/MacOS/AIOrchestrator"
...
chmod +x "$BUILD_DIR/$APP_NAME.app/Contents/MacOS/AIOrchestrator"
...
elif [ -f "/Users/hassan/local-ai/icns/AI Orchestrator.icns" ]; then
    echo -e "Copying AI Orchestrator icon as logo..."
    cp "/Users/hassan/local-ai/icns/AI Orchestrator.icns" "$BUILD_DIR/$APP_NAME.app/Contents/Resources/AppIcon.icns"
fi
