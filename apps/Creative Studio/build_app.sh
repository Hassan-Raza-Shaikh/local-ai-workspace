#!/bin/bash
# ==============================================================================
#                 Creative Studio Compilation and Packaging Script
# ==============================================================================
set -e

# App configuration parameters
APP_NAME="Creative Studio"
SRC_DIR="/Users/hassan/local-ai/apps/Creative Studio"
...
echo -e "${BOLD}===========================================${NC}"
echo -e "${BOLD}      Compiling Creative Studio App        ${NC}"
echo -e "${BOLD}===========================================${NC}\n"
...
swiftc -O \
    ...
    -sdk "$SDK_PATH" \
    "$SRC_DIR/main.swift" \
    -o "$BUILD_DIR/$APP_NAME.app/Contents/MacOS/CreativeStudio"
...
chmod +x "$BUILD_DIR/$APP_NAME.app/Contents/MacOS/CreativeStudio"
...
elif [ -f "/Users/hassan/local-ai/icns/Creative Studio.icns" ]; then
    echo -e "Copying Creative Studio icon as logo..."
    cp "/Users/hassan/local-ai/icns/Creative Studio.icns" "$BUILD_DIR/$APP_NAME.app/Contents/Resources/AppIcon.icns"
fi
