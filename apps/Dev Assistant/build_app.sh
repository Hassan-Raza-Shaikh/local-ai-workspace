#!/bin/bash
# ==============================================================================
#                 Dev Assistant Compilation and Packaging Script
# ==============================================================================
set -e

# App configuration parameters
APP_NAME="Dev Assistant"
SRC_DIR="/Users/hassan/local-ai/apps/Dev Assistant"
...
echo -e "${BOLD}===========================================${NC}"
echo -e "${BOLD}      Compiling Dev Assistant App          ${NC}"
echo -e "${BOLD}===========================================${NC}\n"
...
chmod +x "$SRC_DIR/run_browser_agent.py"
...
swiftc -O \
    ...
    -sdk "$SDK_PATH" \
    "$SRC_DIR/main.swift" \
    -o "$BUILD_DIR/$APP_NAME.app/Contents/MacOS/DevAssistant"
...
chmod +x "$BUILD_DIR/$APP_NAME.app/Contents/MacOS/DevAssistant"

# Copy python helper script into the Resources directory so it is bundled
cp "$SRC_DIR/run_browser_agent.py" "$BUILD_DIR/$APP_NAME.app/Contents/Resources/run_browser_agent.py"

# Copy AppIcon.icns if available in source directory, otherwise fallback to existing Dev Assistant icon
...
elif [ -f "/Users/hassan/local-ai/icns/Dev Assistant.icns" ]; then
    echo -e "Copying Dev Assistant icon as logo..."
    cp "/Users/hassan/local-ai/icns/Dev Assistant.icns" "$BUILD_DIR/$APP_NAME.app/Contents/Resources/AppIcon.icns"
fi
